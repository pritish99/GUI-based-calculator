...
#Operators button
plus=Button(window,text='+',width=6,font='30',command=insertplus)
plus.place(x=390,y=170)

minus=Button(window,text='-',width=6,font='30',command=insertminus)
minus.place(x=390,y=220)

mult=Button(window,text='*',width=6,font='30',command=insertmult)
mult.place(x=390,y=270)

div=Button(window,text='/',width=6,font='30',command=insertdiv)
div.place(x=390,y=320)

par1=Button(window,text='(',width=6,font='30',command=insertpar1)
par1.place(x=20,y=450)

par2=Button(window,text=')',width=6,font='30',command=insertpar2)
par2.place(x=120,y=450)

dot=Button(window,text='.',width=6,font='30',command=insertdot)
dot.place(x=220,y=450)

#Equal to button
eq=Button(window,text='=',width=6,font='30',command=commands)
eq.place(x=390,y=370)
